...
const bcrypt = require('bcryptjs'); // Asegúrate de importar bcrypt aquí también
...
const userService = {
  ...
  registerUser: async (data) => {
    // El 'data' viene del controlador y ya tiene name, email, password.
  ...
  loginUser: async (email, password) => {
    ...
    // 2. Comparar la contraseña hasheada (usa el método 'comparePassword' del modelo)
